...
# NAME: Michael Evans
# DATE: 02/24/2026
# BRIEF DESCRIPTION:  Analyze an email subject line to detect phishing attempts based on common red flags
...
subject = str(input("Enter the email subject line: ")).lower()
print()
...
It was a little hard since the variable comes at the end instead of the front like other comparisons.
